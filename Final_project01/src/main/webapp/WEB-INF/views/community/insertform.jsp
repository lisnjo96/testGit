	...
	<div class="bootstrap-form">
		<form action="insert.do" method="post">
		 <div class="form-group row">
		 	<label class="col-sm-2 col-form-label text-right" for="secret2">비밀글 여부</label>
	        <div class="col-sm-2">
	          <input type="checkbox" name="secret2" id="secret2"/>
	        </div>
	      </div>
	      <div class="form-group row">
			<label class="col-sm-2 col-form-label text-right" for="writer">작성자</label>
			<div class="col-sm-10">
		  ...
		  <div class="form-group row">
			<label class="col-sm-2 col-form-label text-right" for="title">제목</label>
			<div class="col-sm-10">
		  ...
		  <div class="form-group row">
			...
			<div class="form-group row">
				...
				<div class="col-xs-10">
					...
					<input class="form-control" type="button" onclick="submitContents(this);" value="서버로 내용 전송" />
