...
import com.mycom.game.community.dao.BoardDao;
...
public class BoardServiceImpl implements BoardService{
	...
	public void getData(HttpServletRequest request) {
		...
		int noNum=0;
		String excellrent=request.getParameter("excellrent");
		...
		if(id!=null) {
			isLogin=true;
			if(excellrent!=null) {
				dao.addExcellrentCount(num);
				dao.addGradeCount(num);
			}else if(good!=null) {
				dao.addGoodCount(num);
				dao.addGradeCount(num);
			}else if(bad!=null) {
				dao.addBadCount(num);
				dao.addGradeCount(num);
